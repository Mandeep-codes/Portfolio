...
function PanelHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
      ...
      className={cn(
        "screen-line-bottom px-4 py-0.5 has-data-[slot=panel-description]:*:data-[slot=panel-title]:screen-line-bottom",
        className
      )}
      {...props}
    />
...
function PanelTitle({
  ...
  return (
    <Comp
      ...
      className={cn(
        "font-heading text-2xl font-bold tracking-tight pl-3 border-l-2 border-info/70",
        className
      )}
      {...props}
    />
